...
layout = [
    ...
    [sg.Text("クラス", size = (15, 1)), sg.InputText("", size = (20, 1))],
    [sg.Text("レアリティ", size = (15, 1)), sg.InputText("", size = (20, 1))],
    [sg.Text("タイプ", size = (15, 1)), sg.InputText("-", size = (20, 1))],
